...
PLAYER_SETTINGS = [
    ('Human', None),
    ('AI: random', dominoes_lib.players.random),
    ('AI: omniscient', dominoes_lib.players.omniscient()),
     ('AI: bota gorda', dominoes_lib.players.bota_gorda),
]
...
series = dominoes_lib.Series(target_score=target_score)
game = series.games[0]
        ...
        if player_setting is None:
            ...
            while True:
                ...
                try:
                    ...
                    break
                except dominoes_lib.EndsMismatchException:
