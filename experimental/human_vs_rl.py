"""
this script will soon be deleted. It is a human v RL test case.
"""
...
player_settings = [('Human', None), ('AI: RL', q_agent), ('AI: RL',
                                                          q_agent), ('AI: RL', q_agent)]  # TO-DO: remove redundancy
...
while game.result is None:
    ...
    if player is None:
        ...
        print(
            f'Player {(game.turn -1)%4} chose to play {move_tile} on the {side_word} end of the board.')
