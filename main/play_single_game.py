...
# start a game with n dominoes per player
n = validated_input('How many dominoes per player? ',
                    validate_and_transform_target_score,
                    'Please enter a positive integer between 2 and 4.')

game = dominoes.Game.new(tiles_per_hand=n)
